...
byte_alphabet::byte_alphabet(const byte_alphabet& bas)
...
byte_alphabet::byte_alphabet(byte_alphabet&& bas)
	: char2comp(m_char2comp)
	, comp2char(m_comp2char)
	, C(m_C)
	, sigma(m_sigma)
...
byte_alphabet::size_type
byte_alphabet::serialize(std::ostream& out, structure_tree_node* v, std::string name) const
{
